@extends('system.layouts.systemApp')
...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            {{-- start cover image --}}
            @include('system.pages.profile.partials.coverImage')
            {{-- end cover image --}}

            <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
                <div class="row g-4">
                    {{-- start profile image --}}
                    @include('system.pages.profile.partials.profileImage')
                    {{-- end profile image --}}

                    <!--end col-->
                    <div class="col">
                        <div class="p-2">
                            <h3 class="text-white mb-1">A Hasan Reza</h3>
                            <p class="text-white text-opacity-75">Founder & CEO</p>
                            <div class="hstack text-white-50 gap-1">
                                <div class="me-2"><i
                                        class="ri-map-pin-user-line me-1 text-white text-opacity-75 fs-16 align-middle">
                                    </i>Mymensingh, Bangladesh</div>
                                <div>
                                    <i class="ri-building-line me-1 text-white text-opacity-75 fs-16 align-middle"></i> RAMK Soft Tech
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="d-flex profile-wrapper">
                            ...
                            <div class="flex-shrink-0">
                                <a href="{{ asset('edit-profile') }}" class="btn btn-success"><i

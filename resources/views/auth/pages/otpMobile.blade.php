            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-7 col-xl-6">
                        ...
                        <div class="card-body bg-transparent text-white p-4">
                            ...
                            <div class="p-2 mt-4">
                                <div class="text-muted text-center mb-4 mx-lg-3">
                                    <h4 class="text-warning">Verify Your Mobile</h4>
                                    <p class="text-white">Please enter the 6 digit code sent to <span
                                            class="fw-semibold">+8801937913457</span></p>
                                </div>
                    ...
                    <div class="mt-4 text-center">
                        <p class="mb-0 text-white">Didn't receive a code ? <a href="{{ asset('password-reset-mobile') }}"
